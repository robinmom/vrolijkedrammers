...
4. Vanaf fase 3 per environment ook `DVD_PORTAL_CLIENT_ID`, `DVD_GRAPH_CLIENT_ID` + `DVD_GRAPH_CERTIFICATE_NAME` (provisioning-app) en eenmalig `DVD_BOOTSTRAP_ADMIN` (zie [entra-external-id §3b](entra-external-id.md#3b-fase-3-provisioning-eerste-beheerder-en-mfa)).
